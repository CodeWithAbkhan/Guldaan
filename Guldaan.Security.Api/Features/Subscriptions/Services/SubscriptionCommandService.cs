...
using Guldaan.Security.Api.Features.ErrorsShared;
using Guldaan.Security.Api.Features.Subscriptions.Errors;
...
namespace Guldaan.Security.Api.Features.Subscriptions.Services
{
