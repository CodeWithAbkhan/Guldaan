...
using Guldaan.Common.Auth;
using Guldaan.Common.Frontend.Auth;
using Guldaan.Common.Frontend.HttpClients;
...
using Guldaan.Security.UI.Components;
using Guldaan.Security.UI.Httpclients;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(Guldaan.Security.UI.Client._Imports).Assembly);
